...
static const char *const autostart[] = {
  ...
  // "xautolock", "-time", "7", "-locker", "betterlockscreen -l dim", "-killtime", "30", "-killer", "loginctl suspend", "-notify", "30", "-notifier", "notify-send 'NOTICE' 'sebentar lagi dikunci'"  
  "sh", "-c", "~/Dotfiles/bin/xautolock.sh", NULL,
  "sh", "-c", "pkill -f '/bin/dash /home/novores/Dotfiles/bin/dwmstatus/bar.sh'; ~/Dotfiles/bin/dwmstatus/bar.sh", NULL,
	NULL /* terminate */
};
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,           XK_l,       spawn,        SHCMD("xautolock -locknow -locker 'betterlockscreen -l dim' -killtime 10 -killer 'loginctl suspend' -detectsleep") }, 
  //launcher
