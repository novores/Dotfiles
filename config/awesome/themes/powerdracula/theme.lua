...
--color variable
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerdracula"
...
theme.taglist_squares_sel                       = none --theme.dir .. "/icons/square_sel.png"
theme.taglist_squares_unsel                     = none --theme.dir .. "/icons/square_unsel.png"
...
theme.widget_osicon                             = theme.dir .. "/icons/archlogo.png"
...
--os logo
local osicon = wibox.widget.imagebox(theme.widget_osicon)
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_fg_focus, artist) .. title))
    end
})
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox_right = awful.wibar({ position = "top", screen = s, height = dpi(18), bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mywibox_right:setup {
        ...
        { -- Left widgets
            ...
            spr,
            wibox.container.background(osicon,theme.bg_focus),
            arrr_dl,
            spr,
            arrr_ld,
        ...
        { -- Right widgets
            ...
            clock,
            spr,
            separators.arrow_left("alpha",theme.bg_focus),
